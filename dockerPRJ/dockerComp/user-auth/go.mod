...
replace (
	...
	sigs.k8s.io/structured-merge-diff => github.com/kubernetes-sigs/structured-merge-diff v0.0.0-20190521201008-1c46bef2e9c8
	sigs.k8s.io/yaml => github.com/kubernetes-sigs/yaml v1.1.0

)

require (
	github.com/LiuBaiSMD/goProPlugins/user/base v0.0.0-20190812061729-8d1f72939b39
	...
	github.com/xuyiwenak/bambooRat/modprojects/user/base v0.0.0-20190808093648-95cb992ef1a1
)
