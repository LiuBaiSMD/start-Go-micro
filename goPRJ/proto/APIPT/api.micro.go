...
type TestService interface {
	TestReq(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *testService) TestReq(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "Test.TestReq", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type TestHandler interface {
	TestReq(context.Context, *Request, *Response) error
}

func RegisterTestHandler(s server.Server, hdlr TestHandler, opts ...server.HandlerOption) error {
	type test interface {
		TestReq(ctx context.Context, in *Request, out *Response) error
	}
	type Test struct {
		test
	}
...
func (h *testHandler) TestReq(ctx context.Context, in *Request, out *Response) error {
	return h.TestHandler.TestReq(ctx, in, out)
}
